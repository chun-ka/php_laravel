            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-5" id="exampleModalLabel">Chat With
                            {{ receiverid }}{{ receivername }} </h5>
                    ...
                    <form @submit.prevent="sendMsg()">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" v-model="form.msg" rows="3" placeholder=""></textarea>
