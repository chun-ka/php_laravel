                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" action="{{route('update.post')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                  rows="3" name="short_descp">{{$post->short_descp}}</textarea>
                                    </div>
                                </div><!-- Col -->
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="long_descp" id="tinymceExample"
                                                  rows="10">{!! $post->long_descp !!}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <img class="wd-80 rounded-circle" id="showImage" src="{{asset($post->post_image)}}" alt="profile">
                                </div>
