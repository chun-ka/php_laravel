                            ...
                            <form id="myForm" class="forms-sample" method="post" action="{{route('update.permission')}}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name='group_name' class="form-select"
                                        ...
                                        <option value="amenitie" {{$permission->group_name=='amenities'?'selected':''}}>Amenitie</option>
                                        ...
                                        <option value="manage" {{$permission->group_name=='manage'?'selected':''}}>Testimonials Manage</option>
