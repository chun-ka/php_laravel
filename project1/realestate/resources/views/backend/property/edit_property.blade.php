                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name='agent_id' class="form-select"
                                                ...
                                                @foreach($activeAgent as $agent)
                                                    <option
                                                        value="{{$agent->id}}" {{$property->agent_id==$agent->id?'selected':''}}>{{$agent->name}}</option>
                                                @endforeach
                                            </select>
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{route('update.property.thambnail')}}"
                                  enctype="multipart/form-data">
                                @csrf
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{route('update.property.multiimage')}}"
                                  enctype="multipart/form-data">
                                @csrf
                            ...
                            <form id="myForm" method="post" action="{{route('store.new.multiimage')}}"
                                  enctype="multipart/form-data">
                                @csrf
