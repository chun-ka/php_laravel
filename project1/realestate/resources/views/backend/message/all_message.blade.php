                            ...
                            <div class="col-lg-3 border-end-lg">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="order-first">
                                        <h4>Mail Service</h4>
                                        <p class="text-muted">trungnoo196@gmail.com</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            <div class="d-flex align-items-end mb-2 mb-md-0">
                                                ...
                                                <span class="text-muted">({{count($usermsg)}} new message)</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                    ...
                                    @foreach($usermsg as $msg)
                                        <div class="email-list-item">
                                            <a href="" class="email-list-detail">
                                                ...
                                                <span class="date">
                                                <span class="icon"><i data-feather="paperclip"></i> </span>{{$msg->created_at->format('l M d')}}</span>
                                            </a>
                                        </div>
                                    @endforeach
