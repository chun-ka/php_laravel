                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" action="{{route('update.testimonials')}}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="old_img" value="{{$testimonials->image}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1"
                                              rows="3" name="message" >{{$testimonials->message}}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <img class="wd-80 rounded-circle" id="showImage" src="{{asset($testimonials->image)}}" alt="profile">
                                </div>
