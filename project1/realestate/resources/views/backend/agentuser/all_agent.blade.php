...
@section('admin')
    ...
    <!-- Link Chức năng Admin chuyển đổi trạng thái actice/inactive của Agent  -->
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    url('upload/agent_images/'.$item->photo):url('upload/no_image.jpg')}}" style="width: 70px;height: 40px">
                                        </td>
                                        <td>{{$item->name}}</td>
                                        <td>{{$item->role}}</td>
                                        <td>
            ...
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        const Toast = Swal.mixin({    //sử dụng thêm thư viện sweet alert
                            toast: true,
                            position: 'top-end',
                            icon: 'success',
