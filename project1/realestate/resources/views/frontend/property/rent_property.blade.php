                            ...
                            <div class="widget-content">
                                <div class="select-box">
                                    <select class="wide" name="property_status">
                                        <option data-display="All Status" value="">All Status</option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="ptype_id">
                                        <option data-display="Type" value="" >All Type</option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="state">
                                        <option data-display="State" selected="" value="">All State</option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="bathrooms">
                                        <option data-display="BathRooms" value="">Max BathRooms</option>
                                                    ...
                                                    <div class="author-box pull-right">
                                                        ...
                                                        @if($item->agent_id==null)
                                                            ...
                                                            <figure class="author-thumb">
                                                                <img
                                                                    src="{{url('upload/2023062015548423ED23-522F-4081-9471-D0ACE0737357_1_201_a.jpeg')}}"
                                                                    alt="">
                                                                <span>Admin</span>
                                                            </figure>
                                                        ...
                                                        @else
                                                            ...
                                                            <figure class="author-thumb">
                                                                <img src="{{(!empty($item->user->photo))?
                                                                    url('upload/agent_images/'.$item->user->photo):url('upload/no_image.jpg')}}"
                                                                     alt="">
