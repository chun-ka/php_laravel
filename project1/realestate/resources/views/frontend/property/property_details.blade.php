                    ...
                    <div class="property-details-content">
                        ...
                        <div class="details-box content-widget">
                            ...
                            <ul class="list clearfix">
                                ...
                                <li>Garage Size: <span>{{$property->garege_size}} Sq Ft</span></li>
                        ...
                        <div class="statistics-box content-widget">
                            ...
                            <figure class="image-box">
                                <iframe width="700" height="400" src="{{$property->property_video}}"
                            ...
                            <div class="author-box">
                                ...
                                @if($property->agent_id==null)
                                    ...
                                    <div class="inner">
                                        <h4>Admin</h4>
                                        <ul class="info clearfix">
                                            <li><i class="fas fa-map-marker-alt"></i>Đăk Lăk, Việt Nam</li>
                                            <li><i class="fas fa-phone"></i><a href="tel:0898212386">0898212386</a></li>
                                        </ul>
