                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    ...
                    url('upload/admin_images/'.$blog->user->photo):url('upload/no_image.jpg')}}" alt=""></figure>
                        ...
                        url('upload/user_images/'.$com->user->photo):url('upload/no_image.jpg')}}" alt="">
                                    ...
                                    @foreach($reply as $rep)
                                        ...
                                        <div class="comment replay-comment">
                                            <figure class="thumb-box">
                                                <img src="{{url('upload/2023062015548423ED23-522F-4081-9471-D0ACE0737357_1_201_a.jpeg')}}" alt="">
                                            </figure>
                                            <div class="comment-inner">
                                                <div class="comment-info clearfix">
                                                    <h5>{{$rep->subject}}</h5>
                        ...
                        <div class="comments-form-area">
                            ...
                            @else
                                <p>For Add Comment You need to login first <a href="{{route('login')}}">Login Here</a>
                                </p>
                            @endauth
