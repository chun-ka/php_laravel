            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                    <div class="blog-sidebar">
                        ...
                        url('upload/user_images/'.$userData->photo):url('upload/no_image.jpg')}}" alt=""></a>
                                    </figure>
                                ...
                                <div class="lower-content">
                                    ...
                                    <form action="{{route('user.profile.store')}}" method="post" class="default-form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{(!empty($userData->photo))?
                        url('upload/user_images/'.$userData->photo):url('upload/no_image.jpg')}}" id="showImage" alt="" style="width: 100px;height: 100px">
                                        </div>
